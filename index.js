		...
		fetched = await fetch(
			"https://session.coolmathblox.ca/launch/queue_minigame",
			{
				...
				headers: {
					...
					priority: "u=1, i",
					"sec-ch-ua":
						'"Microsoft Edge";v="133", "Chromium";v="133", "Not_A Brand";v="99"',
					"sec-ch-ua-mobile": "?0",
...
(async () => {
	let r = await fetch("https://miniblox.io/", {
		method: "GET",
		headers: {
			"User-Agent":
				"Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/133.0.0.0 Safari/537.36 Edg/133.0.0.0",
	...
	let js = (await r.text()).match(/\/assets\/index-[a-zA-Z0-9]*\.js/g)[0];

	r = await fetch("https://miniblox.io" + js, {
		method: "GET",
		headers: {
			"User-Agent":
				"Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/133.0.0.0 Safari/537.36 Edg/133.0.0.0",
