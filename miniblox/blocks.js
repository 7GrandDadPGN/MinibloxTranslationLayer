...
for (let i = 0; i < 4; i++) BLOCKS[10 + i] = [mcData.blocksByName.dirt.id, i % 4];
BLOCKS[14] = mcData.blocksByName.cobblestone.id;
for (let i = 0; i < 6; i++) BLOCKS[15 + i] = [mcData.blocksByName.planks.id, i];
for (let i = 0; i < 12; i++) BLOCKS[21 + i] = mcData.blocksByName.sapling.id;
...
for (let i = 0; i < 72; i++) BLOCKS[76 + i] = [mcData.blocksByName.log.id, i % 3];
for (let i = 0; i < 112; i++) BLOCKS[148 + i] = [mcData.blocksByName.leaves.id, i % 7];
...
for (let i = 0; i < 800; i++) BLOCKS[281 + i] = [mcData.blocksByName.noteblock.id, i];
for (let i = 0; i < 256; i++) BLOCKS[1081 + i] = [mcData.blocksByName.bed.id, i % 16];
...
for (let i = 0; i < 2; i++) BLOCKS[1486 + i] = mcData.blocksByName.tnt.id;
...
BLOCKS[1491] = [mcData.blocksByName.torch.id, 4];
for (let i = 0; i < 4; i++) BLOCKS[1492 + i] = [mcData.blocksByName.torch.id, i];
...
for (let i = 0; i < 24; i++) BLOCKS[2090 + i] = [mcData.blocksByName.chest.id, 2 + i];
for (let i = 0; i < 1296; i++) BLOCKS[2114 + i] = [mcData.blocksByName.redstone_wire.id, i];
...
for (let i = 0; i < 8; i++) BLOCKS[3430 + i] = [mcData.blocksByName.furnace.id, i];
for (let i = 0; i < 192; i++) BLOCKS[3438 + i] = [mcData.blocksByName.standing_sign.id, Math.min(i % 32, 15)];
for (let i = 0; i < 64; i++) BLOCKS[3630 + i] = [mcData.blocksByName.wooden_door.id, i % 4];
...
for (let i = 0; i < 48; i++) BLOCKS[3802 + i] = [mcData.blocksByName.wall_sign.id, i % 4];
for (let i = 0; i < 24; i++) BLOCKS[3850 + i] = [mcData.blocksByName.lever.id, i];
for (let i = 0; i < 2; i++) BLOCKS[3874 + i] = [mcData.blocksByName.stone_pressure_plate.id, i];
for (let i = 0; i < 64; i++) BLOCKS[3876 + i] = [mcData.blocksByName.iron_door.id, i];
...
for (let i = 0; i < 2; i++) BLOCKS[3956 + i] = [mcData.blocksByName.redstone_torch.id, 4];
for (let i = 0; i < 8; i++) BLOCKS[3958 + i] = [mcData.blocksByName.redstone_torch.id, i % 4];
for (let i = 0; i < 24; i++) BLOCKS[3966 + i] = [mcData.blocksByName.stone_button.id, i];
...
for (let i = 0; i < 32; i++) BLOCKS[4035 + i] = [mcData.blocksByName.fence.id, i % 16];
...
BLOCKS[4077] = [mcData.blocksByName.torch.id, 4];
for (let i = 0; i < 3; i++) BLOCKS[4078 + i] = [mcData.blocksByName.torch.id, i];
...
for (let i = 0; i < 64; i++) BLOCKS[4100 + i] = [mcData.blocksByName.powered_repeater.id, i % 32];
for (let i = 0; i < 16; i++) BLOCKS[4164 + i] = [mcData.blocksByName.stained_glass.id, i];
for (let i = 0; i < 384; i++) BLOCKS[4180 + i] = [mcData.blocksByName.trapdoor.id, i % 32];
...
for (let i = 0; i < 32; i++) BLOCKS[4766 + i] = [mcData.blocksByName.iron_bars.id, i % 16];
for (let i = 0; i < 6; i++) BLOCKS[4798 + i] = mcData.blocksByName.iron_bars.id;
...
for (let i = 0; i < 160; i++) BLOCKS[4861 + i] = [mcData.blocksByName.vine.id, i % 32];
for (let i = 0; i < 32; i++) BLOCKS[5021 + i] = [mcData.blocksByName.fence_gate, i];
...
for (let i = 0; i < 32; i++) BLOCKS[5217 + i] = [mcData.blocksByName.nether_brick_fence.id, i];
...
for (let i = 0; i < 8; i++) BLOCKS[5457 + i] = [mcData.blocksByName.ender_chest.id, 2 + i];
for (let i = 0; i < 16; i++) BLOCKS[5465 + i] = [mcData.blocksByName.tripwire_hook.id, i];
for (let i = 0; i < 128; i++) BLOCKS[5481 + i] = [mcData.blocksByName.tripwire.id, i];
...
for (let i = 0; i < 324; i++) BLOCKS[5863 + i] = [mcData.blocksByName.cobblestone_wall.id, i];
for (let i = 0; i < 324; i++) BLOCKS[6187 + i] = [mcData.blocksByName.cobblestone_wall.id, i];
for (let i = 0; i < 24; i++) BLOCKS[6511 + i] = [mcData.blocksByName.flower_pot.id, i];
...
for (let i = 0; i < 144; i++) BLOCKS[6552 + i] = [mcData.blocksByName.wooden_button.id, i % 24];
for (let i = 0; i < 120; i++) BLOCKS[6696 + i] = [mcData.blocksByName.skull.id, i % 20];
for (let i = 0; i < 12; i++) BLOCKS[6816 + i] = [mcData.blocksByName.anvil.id, i];
for (let i = 0; i < 24; i++) BLOCKS[6828 + i] = [mcData.blocksByName.trapped_chest.id, i];
...
for (let i = 0; i < 64; i++) BLOCKS[7787 + i] = [mcData.blocksByName.iron_trapdoor.id, i % 32];
...
for (let i = 0; i < 6; i++) BLOCKS[8094 + i] = [mcData.blocksByName.stone_slab.id, i % 4];
for (let i = 0; i < 6; i++) BLOCKS[8100 + i] = [mcData.blocksByName.stone_slab.id, i % 4];
for (let i = 0; i < 6; i++) BLOCKS[8106 + i] = [mcData.blocksByName.stone_slab.id, i % 4];
BLOCKS[8112] = mcData.blocksByName.sea_lantern.id;
for (let i = 0; i < 3; i++) BLOCKS[8113 + i] = [mcData.blocksByName.hay_block.id, i];
...
for (let i = 0; i < 36; i++) BLOCKS[8550 + i] = [mcData.blocksByName.wooden_slab.id, i % 4];
for (let i = 0; i < 78; i++) BLOCKS[8586 + i] = [mcData.blocksByName.stone_slab.id, i % 4];
